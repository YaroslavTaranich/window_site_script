...
var modals = function modals(state) {
  function bindModal(triggerSelectr, modalSelector, closeSelector) {
    var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var trigger = document.querySelectorAll(triggerSelectr),
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      document.querySelector(selector).style.display = "block"; // document.body.style.overflow = "";
...
var tabs = function tabs(headerSelector, tabSecector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabSecector.replace(/\./, "")) || target.parentNode.classList.contains(tabSecector.replace(/\./, "")))) {
